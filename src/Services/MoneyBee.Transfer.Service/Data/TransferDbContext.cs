...
using MoneyBee.Transfer.Service.Entities;
using MoneyBee.Common.Enums;

namespace MoneyBee.Transfer.Service.Data;
...
public class TransferDbContext : DbContext
{
    ...
    public DbSet<Entities.Transfer> Transfers { get; set; }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        base.OnModelCreating(modelBuilder);

        modelBuilder.Entity<Entities.Transfer>(entity =>
        {
